...
from litecoinutils.transactions import Transaction, TxInput, TxOutput, Sequence
from litecoinutils.keys import P2pkhAddress, P2shAddress, PrivateKey
from litecoinutils.script import Script
from litecoinutils.constants import TYPE_RELATIVE_TIMELOCK
