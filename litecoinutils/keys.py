...
class Address(ABC):
    ...
    def __init__(self, address=None, hash160=None, script=None):
        ...
        if hash160:
            ...
            if isinstance(script, litecoinutils.script.Script):
...
class P2pkhAddress(Address):
    ...
    def to_script_pub_key(self):
        """Returns the scriptPubKey (P2PKH) that corresponds to this address"""
        return litecoinutils.script.Script(['OP_DUP', 'OP_HASH160',
...
class SegwitAddress(ABC):
	...
	"""
        ...
        witness_version, witness_int_array = litecoinutils.bech32.decode(NETWORK_SEGWIT_PREFIXES[get_network()], address)
    ...
    def to_string(self):
        ...
        return litecoinutils.bech32.encode(NETWORK_SEGWIT_PREFIXES[get_network()],
...
class P2wpkhAddress(SegwitAddress):
    ...
    def to_script_pub_key(self):
        """Returns the scriptPubKey of a P2WPKH witness script"""
        return litecoinutils.script.Script(['OP_0', self.to_hash()])
